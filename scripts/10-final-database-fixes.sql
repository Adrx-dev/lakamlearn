-- Final comprehensive database fixes to eliminate all errors
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_posts_published_created ON posts(published, created_at DESC);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_posts_author_published ON posts(author_id, published);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_posts_category_published ON posts(category_id, published) WHERE published = true;
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_posts_slug_published ON posts(slug, published) WHERE published = true;
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_comments_post_parent ON comments(post_id, parent_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_comments_author_created ON comments(author_id, created_at DESC);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_comments_parent_created ON comments(parent_id, created_at) WHERE parent_id IS NOT NULL;

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_reading_list_user_created ON reading_list(user_id, created_at DESC);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_reading_list_post_user ON reading_list(post_id, user_id);
